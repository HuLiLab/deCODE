...
To run DNE, please call the main python script with a project name and a data file:
DNE_STEP=0 python decode_main.py <project_name> <input_file_name>
e.g.
DNE_STEP=0 python decode_main.py RD GSE25066_RAW_scan_symbol_samplename_RD.txt
